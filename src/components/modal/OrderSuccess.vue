...
<template>
    <div>
        <div class="modal fade modal-wrapper" id="OrderSuccess">
                    ...
                    <div class="modal-body">
                        <div id='card' class="animated fadeIn">
                            ...
                            <div id='lower-side'>
                                ...
                                <button class="btn btn-info" @click.prevent="goHome"><i class="fa fa-home" style="font-size: 20px;"></i> Go Home</button>
                            </div>
                            </div>
