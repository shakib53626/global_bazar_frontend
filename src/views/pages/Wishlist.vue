                                ...
                                <table class="table">
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td class="li-product-thumbnail"><a href="#"><img src="@/assets/images/wishlist-thumb/1.jpg" alt=""></a></td>
                                        ...
                                        <tr>
                                            <td class="li-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                            <td class="li-product-thumbnail"><a href="#"><img src="@/assets/images/wishlist-thumb/2.jpg" alt=""></a></td>
                                        ...
                                        <tr>
                                            <td class="li-product-remove"><a href="#"><i class="fa fa-times"></i></a></td>
                                            <td class="li-product-thumbnail"><a href="#"><img src="@/assets/images/wishlist-thumb/3.jpg" alt=""></a></td>
